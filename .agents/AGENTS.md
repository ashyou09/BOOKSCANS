...
- When working with infrastructure, follow AWS Well-Architected Framework principles (least privilege IAM, encryption at rest/in transit, proper resource tagging).
